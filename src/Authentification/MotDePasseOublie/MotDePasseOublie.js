...
import CodeVer from "./CodeVerification/CodeVerification" ;


import EmailVerification from "./EmailVerification/EmailVerification";

import NouvMotDePasse from "./NouvMotDePasse/NouvMotDePasse" ;
...
function MotDePasseOublie() {
    ...
    const Navigate = useNavigate();
       ...
       const[Email_G , setEmail_G] = useState('');
       const[Code_G , setCode_G] = useState('');
    ...
    return (
        <div className="MotDePasseOublie">
            <div className="EmplacementMotDePasseOublie">
              {T == 0 ? <EmailVerification setT = {setT} setEmail_G = {setEmail_G}  setCode_G = {setCode_G} /> : T==1 ? <CodeVer Id = {Code_G} setT = {setT} /> :<NouvMotDePasse Id = {Code_G} setT = {setT}/>}
            </div>
            <button id="dark-mode-toggle" className="dark-mode-toggle mb-5" onClick={() => {
                ...
                <svg width="100%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 496"  style={{marginBottom : '12px'}}><path fill="currentColor" d="M8,256C8,393,119,504,256,504S504,393,504,256,393,8,256,8,8,119,8,256ZM256,440V72a184,184,0,0,1,0,368Z" transform="translate(-8 -8)" /></svg>
            </button>
