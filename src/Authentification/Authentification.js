...
export default function Authentification() {
    ...
    return (
        <div className="Authentification">
            <div className="EmplacementAuthentification">
                <div className="d-flex flex-column flex-sm-column flex-md-column flex-lg-row">
                <div className="EmplacementBAMS">
                    <img src={BamsImage} alt="" />
                   <div className="Description">
                   <h2>Add a best chat Bams To your website connect . <br /> other channels and automate sales & support <br />. with Bams</h2>
                   </div>
                    <div className="SubReadMore">
